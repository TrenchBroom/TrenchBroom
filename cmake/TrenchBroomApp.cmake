...
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
    ...
    CONFIGURE_FILE(${APP_DIR}/resources/linux/postinst ${CMAKE_CURRENT_BINARY_DIR}/postinst @ONLY)
    CONFIGURE_FILE(${APP_DIR}/resources/linux/prerm ${CMAKE_CURRENT_BINARY_DIR}/prerm @ONLY)
    CONFIGURE_FILE(${APP_DIR}/resources/linux/postrm ${CMAKE_CURRENT_BINARY_DIR}/postrm @ONLY)

    # create target symlink
    EXECUTE_PROCESS(COMMAND ln -sf ${LINUX_TARGET_EXECUTABLE_PATH} ${CMAKE_CURRENT_BINARY_DIR}/trenchbroom)
    ...
    INSTALL(FILES "${CMAKE_CURRENT_BINARY_DIR}/trenchbroom" DESTINATION /usr/bin COMPONENT TrenchBroom)
