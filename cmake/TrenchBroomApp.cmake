...
IF(APPLE)
    ...
    FILE(GLOB_RECURSE MACOSX_GAME_FILES
         RELATIVE ${APP_DIR}/resources/games
    ...
    FOREACH(GAME_FILE ${MACOSX_GAME_FILES})
        ...
        SET(GAME_FILE "${APP_DIR}/resources/games/${GAME_FILE}")
...
TARGET_LINK_LIBRARIES(TrenchBroom glew ${FREEIMAGE_LIBRARIES} ${FREETYPE_LIBRARIES} vecmath Qt5::Widgets tinyxml2 miniz)
IF (COMPILER_IS_MSVC)
...
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
    ...
    SET(LINUX_RESOURCE_LOCATION "share/Kristian Duske/TrenchBroom")
    ...
    CONFIGURE_FILE("${CMAKE_SOURCE_DIR}/cmake/PrintLinuxPackageInfo.sh.in" "${CMAKE_CURRENT_BINARY_DIR}/print_linux_package_info.sh" @ONLY)
ENDIF()
INCLUDE(CPack)
