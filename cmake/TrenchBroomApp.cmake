...
SET(APP_SOURCE ${APP_SOURCE} ${DOC_MANUAL_TARGET_FILES} ${DOC_MANUAL_TARGET_IMAGE_FILES})
...
IF(APPLE)
    ...
    SET_SOURCE_FILES_PROPERTIES(${DOC_MANUAL_TARGET_IMAGE_FILES} PROPERTIES MACOSX_PACKAGE_LOCATION Resources/manual/images)
ENDIF()
...
IF(WIN32 OR ${CMAKE_SYSTEM_NAME} MATCHES "Linux|FreeBSD")
    ...
    FOREACH(MANUAL_IMAGE_FILE ${DOC_MANUAL_TARGET_IMAGE_FILES})
        ADD_CUSTOM_COMMAND(TARGET TrenchBroom POST_BUILD
