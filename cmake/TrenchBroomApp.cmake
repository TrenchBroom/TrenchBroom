...
IF(APPLE)
    ...
    FILE(GLOB_RECURSE MACOSX_GENERIC_FILES
            "${APP_DIR}/resources/games/Generic/*.*"
            )
    SET(APP_SOURCE ${APP_SOURCE} ${MACOSX_GENERIC_FILES})
    SET_SOURCE_FILES_PROPERTIES(${MACOSX_GENERIC_FILES} PROPERTIES  MACOSX_PACKAGE_LOCATION Resources/games/Generic/)
