...
CHECK_REPOSITORY_CLEAN("${GIT_EXECUTABLE}" "${CMAKE_SOURCE_DIR}")
...
ADD_CUSTOM_COMMAND(TARGET package PRE_BUILD
    COMMAND ${CMAKE_COMMAND} -P ${CMAKE_SOURCE_DIR}/cmake/CheckRepositoryStatus.cmake -DCMAKE_SOURCE_DIR=${CMAKE_SOURCE_DIR}
)
