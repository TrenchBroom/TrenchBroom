...
IF(common_TYPE STREQUAL "SHARED_LIBRARY")
    ...
    TARGET_LINK_LIBRARIES(common glew ${FREEIMAGE_LIBRARIES} ${FREETYPE_LIBRARIES} vecmath tinyxml2 miniz)
ENDIF()

# Would do:
#     TARGET_LINK_LIBRARIES(common Qt5::Widgets)
# but this requires CMake 3.12. Workaround for older CMake: https://bugreports.qt.io/browse/QTBUG-37105
TARGET_INCLUDE_DIRECTORIES(common PRIVATE $<TARGET_PROPERTY:Qt5::Widgets,INTERFACE_INCLUDE_DIRECTORIES>)
TARGET_COMPILE_DEFINITIONS(common PRIVATE $<TARGET_PROPERTY:Qt5::Widgets,INTERFACE_COMPILE_DEFINITIONS>)
