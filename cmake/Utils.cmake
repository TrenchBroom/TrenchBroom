...
MACRO(CHECK_REPOSITORY_CLEAN GIT SOURCE_DIR)
    EXECUTE_PROCESS(COMMAND ${GIT} status WORKING_DIRECTORY ${SOURCE_DIR} OUTPUT_VARIABLE STATUS_RESULT OUTPUT_STRIP_TRAILING_WHITESPACE)
    STRING(FIND "${STATUS_RESULT}" "working directory clean" STATUS_MATCH)
    MESSAGE(STATUS "${STATUS_MATCH}")
