  ...
  if   (wxWidgets_INCLUDE_DIRS)
    if(wxWidgets_INCLUDE_DIRS_NO_SYSTEM)
        if(CMAKE_GENERATOR STREQUAL "Xcode")
            foreach (wxWidgets_INCLUDE_DIR ${wxWidgets_INCLUDE_DIRS})
                set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -isystem ${wxWidgets_INCLUDE_DIR}")
                set(CMAKE_C_FLAGS   "${CMAKE_C_FLAGS}   -isystem ${wxWidgets_INCLUDE_DIR}")
            endforeach(wxWidgets_INCLUDE_DIR)
        else()
