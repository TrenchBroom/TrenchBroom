...
namespace TrenchBroom {
    namespace View {
        TEST_CASE("UpdateLinkedGroupsHelperTest.checkLinkedGroupsToUpdate") {
            ...
            groupNode1.addToLinkSet(linkedGroupNode);
        ...
        TEST_CASE_METHOD(UpdateLinkedGroupsHelperTest, "UpdateLinkedGroupsHelperTest.ownership") {
            ...
            groupNode->addToLinkSet(*linkedNode);
            document->addNodes({{document->parentForNodes(), {linkedNode}}});
        ...
        TEST_CASE_METHOD(UpdateLinkedGroupsHelperTest, "UpdateLinkedGroupsHelperTest.applyLinkedGroupUpdatesWithNestedLinkedGroups") {
            ...
            innerGroupNode->addToLinkSet(*linkedInnerGroupNode);
            ...
            outerGroupNode->addToLinkSet(*linkedOuterGroupNode);
            ...
            REQUIRE(inSameLinkSet(*innerGroupNode, *nestedLinkedInnerGroupNode));

            REQUIRE(linkedInnerGroupNode->connectedToLinkSet());
            REQUIRE(linkedOuterGroupNode->connectedToLinkSet());
            REQUIRE(nestedLinkedInnerGroupNode->connectedToLinkSet());
