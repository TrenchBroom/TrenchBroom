...
TEST_CASE("PreferencesTest.parseV1", "[PreferencesTest]") {
  ...
  CHECK(
    getValue(parsed, IO::Path("Games/Quake 3/Path")) == QJsonValue("/home/ericwa/Quake 3 Arena"));
  CHECK(
    getValue(parsed, IO::Path("Menu/File/Export/Wavefront OBJ...")) == QJsonValue("87:308:307:0"));
  CHECK(
    getValue(parsed, IO::Path("Menu/View/Grid/Set Grid Size 0.125")) == QJsonValue("50:308:307:0"));
  ...
  CHECK(
    getValue(parsed, IO::Path("Persistent_Options/Window/MapFrame/Maximized")) == QJsonValue("0"));
  CHECK(
    getValue(parsed, IO::Path("Persistent_Options/Window/MapFrame/Iconized")) == QJsonValue("0"));
  CHECK(
    getValue(parsed, IO::Path("Persistent_Options/Window/MapFrame/decor_l")) == QJsonValue("0"));
  CHECK(
    getValue(parsed, IO::Path("Persistent_Options/Window/MapFrame/decor_r")) == QJsonValue("0"));
  CHECK(
    getValue(parsed, IO::Path("Persistent_Options/Window/MapFrame/decor_t")) == QJsonValue("37"));
  CHECK(
    getValue(parsed, IO::Path("Persistent_Options/Window/MapFrame/decor_b")) == QJsonValue("0"));
  CHECK(
    getValue(parsed, IO::Path("Persistent_Options/SplitterWindow2/MapFrameHSplitter/SplitRatio")) ==
    QJsonValue("6533"));
  CHECK(
    getValue(parsed, IO::Path("Persistent_Options/SplitterWindow2/MapFrameVSplitter/SplitRatio")) ==
    QJsonValue("8306"));
  CHECK(
    getValue(
      parsed, IO::Path("Persistent_Options/SplitterWindow2/3PaneMapViewHSplitter/SplitRatio")) ==
    QJsonValue("4857"));
  CHECK(
    getValue(
      parsed, IO::Path("Persistent_Options/SplitterWindow2/3PaneMapViewVSplitter/SplitRatio")) ==
    QJsonValue("4850"));
  CHECK(
    getValue(
      parsed, IO::Path("Persistent_Options/SplitterWindow2/EntityInspectorSplitter/SplitRatio")) ==
    QJsonValue("2742"));
  CHECK(
    getValue(
      parsed,
      IO::Path("Persistent_Options/SplitterWindow2/EntityAttributeEditorSplitter/SplitRatio")) ==
    QJsonValue("3333"));
  CHECK(
    getValue(
      parsed,
      IO::Path("Persistent_Options/SplitterWindow2/EntityDocumentationSplitter/SplitRatio")) ==
    QJsonValue("-10000"));
  CHECK(
    getValue(
      parsed, IO::Path("Persistent_Options/SplitterWindow2/FaceInspectorSplitter/SplitRatio")) ==
    QJsonValue("3656"));
  CHECK(getValue(parsed, IO::Path("RecentDocuments/0")) == QJsonValue("/home/ericwa/unnamed.map"));
  CHECK(
    getValue(parsed, IO::Path("Filters/Tags/Detail/Toggle Visible")) == QJsonValue("68:307:0:0"));
  ...
  CHECK(
    getValue(parsed, IO::Path("Entities/monster_hell_knight/Create")) == QJsonValue("72:0:0:0"));
}
...
static void testV2Prefs(const std::map<IO::Path, QJsonValue>& v2) {
  ...
  CHECK(
    static_cast<float>(getValue(v2, IO::Path("Controls/Camera/Fly move speed")).toDouble()) ==
    vm::approx(0.425781f));
  ...
  CHECK(
    ...
    vm::approx(0.22f));
  CHECK(
    getValue(v2, IO::Path("Renderer/Colors/Edges")) == QJsonValue("0.921569 0.666667 0.45098 1"));
  CHECK(
    getValue(v2, IO::Path("Renderer/Colors/Background")) ==
    QJsonValue("0.321569 0.0470588 0.141176 1"));
  CHECK(
    getValue(v2, IO::Path("Rendere/Grid/Color2D")) == QJsonValue("0.290196 0.643137 0.486275 1"));
  ...
  CHECK(
    ...
    QJsonValue(QJsonValue::Undefined));
  CHECK(
    getValue(v2, IO::Path("Persistent_Options/SplitterWindow2/MapFrameHSplitter/SplitRatio")) ==
    QJsonValue(QJsonValue::Undefined));
  CHECK(
    getValue(v2, IO::Path("Persistent_Options/SplitterWindow2/MapFrameVSplitter/SplitRatio")) ==
    QJsonValue(QJsonValue::Undefined));
  CHECK(
    getValue(v2, IO::Path("Persistent_Options/SplitterWindow2/3PaneMapViewHSplitter/SplitRatio")) ==
    QJsonValue(QJsonValue::Undefined));
  CHECK(
    getValue(v2, IO::Path("Persistent_Options/SplitterWindow2/3PaneMapViewVSplitter/SplitRatio")) ==
    QJsonValue(QJsonValue::Undefined));
  CHECK(
    getValue(
      v2, IO::Path("Persistent_Options/SplitterWindow2/EntityInspectorSplitter/SplitRatio")) ==
    QJsonValue(QJsonValue::Undefined));
  CHECK(
    getValue(
      v2,
  ...
  CHECK(
    getValue(
      v2, IO::Path("Persistent_Options/SplitterWindow2/EntityDocumentationSplitter/SplitRatio")) ==
    QJsonValue(QJsonValue::Undefined));
  CHECK(
    getValue(v2, IO::Path("Persistent_Options/SplitterWindow2/FaceInspectorSplitter/SplitRatio")) ==
    QJsonValue(QJsonValue::Undefined));
...
TEST_CASE("PreferencesTest.readV2", "[PreferencesTest]") {
  ...
  CHECK(
    parseV2SettingsFromJSON(QByteArray("abc")).is_error_type<PreferenceErrors::JsonParseError>());
...
TEST_CASE("PreferencesTest.serializeV1Color", "[PreferencesTest]") {
  CHECK_FALSE((maybeDeserialize<PreferenceSerializerV1, Color>(QJsonValue("0.921569 0.666667"))
                 .has_value())); // must give 3 or 4 components

  testSerialize<PreferenceSerializerV1, Color>(
    QJsonValue("0.921569 0.666667 0.45098 0.5"), Color(0.921569f, 0.666667f, 0.45098f, 0.5f));
}
...
TEST_CASE("PreferencesTest.serializeV1KeyboardShortcut", "[PreferencesTest]") {
  ...
  testSerialize<PreferenceSerializerV1, QKeySequence>(
    QJsonValue("80:307:0:0"), QKeySequence::fromString("Alt+P")); // "Alt" in Qt = Alt in macOS
}
...
TEST_CASE("PreferencesTest.serializeV2KeyboardShortcut", "[PreferencesTest]") {
  ...
  testSerialize<PreferenceSerializerV2, QKeySequence>(
    QJsonValue("Meta+W"), QKeySequence::fromString("Meta+W")); // "Meta" in Qt = Control in macOS
}
...
TEST_CASE("PreferencesTest.testWxEntityShortcuts", "[PreferencesTest]") {
  auto hellKnight = Assets::PointEntityDefinition(
    "monster_hell_knight", Color(0, 0, 0), vm::bbox3(), "", {}, Assets::ModelDefinition());
  ...
  const std::vector<IO::Path> actualPrefPaths = kdl::vec_transform(actions, [](const auto& action) {
    return IO::Path(action->preferencePath());
  });
