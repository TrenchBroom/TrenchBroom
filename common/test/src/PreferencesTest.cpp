...
namespace TrenchBroom {
    ...
    TEST_CASE("PreferencesTest.parseV1", "[PreferencesTest]") {
        ...
        EXPECT_EQ(QJsonValue("0.921569 0.666667 0.45098 1"), getValue(parsed, IO::Path("Renderer/Brush edge")));
        EXPECT_EQ(QJsonValue("0.321569 0.0470588 0.141176 1"), getValue(parsed, IO::Path("Renderer/Editing views background")));
        EXPECT_EQ(QJsonValue("0.290196 0.643137 0.486275 1"), getValue(parsed, IO::Path("Renderer/Grid color (2D views)")));
