...
TEST_CASE("resolveInheritance")
{
  ...
  SECTION("overrideMembersIfNotPresent")
  {
    const auto baseModelDef =
      Assets::ModelDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"abc"}}}};
    const auto baseDecalDef =
      Assets::DecalDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"def"}}}};
  ...
  SECTION("mergeModelDefinitions")
  {
    ...
    const auto pointModelDef =
      Assets::ModelDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"xyz"}}}};
  ...
  {
    const auto baseDecalDef =
      Assets::DecalDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"decal1"}}}};
    const auto pointDecalDef =
      Assets::DecalDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"decal2"}}}};
  ...
  SECTION("chainOfBaseClasses")
  {
    ...
    const auto base2ModelDef =
      Assets::ModelDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"def"}}}};
    const auto pointModelDef =
      Assets::ModelDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"xyz"}}}};
    auto mergedModelDef = pointModelDef;
    ...
    const auto base1DecalDef =
      Assets::DecalDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"dec1"}}}};
    const auto base2DecalDef =
      Assets::DecalDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"dec2"}}}};
    const auto pointDecalDef =
      Assets::DecalDefinition{EL::Expression{EL::LiteralExpression{EL::Value{"dec3"}}}};
    auto mergedDecalDef = pointDecalDef;
