...
"name" "entity1"
  ...
  SECTION("Entity definition file handling")
  {
    ...
    SECTION("Add default target_source and target_destination properties")
    {
      ...
      auto game = std::make_unique<MockGame>(std::move(gameConfig));
      game->setEntityDefinitionFiles({
        {entityDefinitionFilePath, {{"some_name", {}, {}, {}, {}, 1}}},
      });
    ...
    SECTION("Convert legacy color properties")
    {
      using namespace EntityPropertyKeys;
      ...
      game->setEntityDefinitionFiles({
        {entityDefinitionFilePath,
         {{"some_name",
           ...
           {},
           {
             PropertyDefinition{"color", PropertyValueTypes::String{}, {}, {}},
           },
           {},
           1}}},
      });
      ...
      CHECK(
        ...
        == std::vector{EntityDefinition{
          ...
          {},
          {
            PropertyDefinition{"color", PropertyValueTypes::Color{}, {}, {}},
            PropertyDefinition{
              Target,
              PropertyValueTypes::LinkSource{},
              "name of entity to trigger",
