...
TEST_CASE("Map_Assets")
{
  ...
  SECTION("entityDefinitionFile")
  {
    ...
    const auto [entityProperty, expectedEntityDefinitionFileSpec] = GENERATE(values<T>({
      {std::nullopt, EntityDefinitionFileSpec::builtin("Quake.def")},
      {"", EntityDefinitionFileSpec::builtin("Quake.def")},
      {"asdf", EntityDefinitionFileSpec::builtin("Quake.def")},
      {"builtin:ad.fgd", EntityDefinitionFileSpec::builtin("ad.fgd")},
      {"builtin:Quake.def", EntityDefinitionFileSpec::builtin("Quake.def")},
      {"external:/Applications/Quake/Quake.fgd",
       EntityDefinitionFileSpec::external("/Applications/Quake/Quake.fgd")},
    }));
  ...
  SECTION("setEntityDefinitionFile")
  {
    ...
    const auto [entityDefinitionFileSpec, expectedPropertyValue] = GENERATE(values<T>({
      {EntityDefinitionFileSpec::builtin("Quake.def"), "builtin:Quake.def"},
      {EntityDefinitionFileSpec::builtin("ad.fgd"), "builtin:ad.fgd"},
      {
        EntityDefinitionFileSpec::external("/Applications/Quake/Quake.fgd"),
        "external:/Applications/Quake/Quake.fgd",
      },
...
[
  message(string) : "Text on entering the world"
    ...
    setEntityDefinitionFile(
      map, EntityDefinitionFileSpec::external(env.dir() / fgdFilename));

    REQUIRE(
      entityDefinitionFile(map)
      == EntityDefinitionFileSpec::external(env.dir() / fgdFilename));
