...
namespace TrenchBroom {
    ...
    namespace IO {
        ...
        protected:
            ...
            void beginEntity(size_t line, const std::vector<Model::EntityProperty>& attributes, const ExtraAttributes& extraAttributes, ParserStatus& status);
        ...
        private: // subclassing interface for users of the parser
            ...
            virtual void onBeginEntity(size_t line, const std::vector<Model::EntityProperty>& attributes, const ExtraAttributes& extraAttributes, ParserStatus& status) = 0;
