...
using GetMipPalette =
  std::function<kdl::result<Assets::Palette, Assets::LoadPaletteError>(Reader& reader)>;

kdl::result<Assets::Palette, Assets::LoadPaletteError> readHlMipPalette(Reader& reader)
{
