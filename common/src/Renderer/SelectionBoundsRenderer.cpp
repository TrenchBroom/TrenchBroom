...
namespace TrenchBroom {
    namespace Renderer {
        ...
        public:
            SizeTextAnchor2D(const vm::bbox3& bounds, const Math::Axis::Type axis, const Renderer::Camera& camera) :
            m_bounds(bounds),
            m_axis(axis),
            m_camera(camera) {}
        private:
        ...
        private:
            ...
            const Camera& m_camera;
        public:
            SizeTextAnchor3D(const vm::bbox3& bounds, const Math::Axis::Type axis, const Renderer::Camera& camera) :
            m_bounds(bounds),
            m_axis(axis),
            m_camera(camera) {}
        private:
