...
namespace TrenchBroom {
    namespace Renderer {
        ...
        public:
            ...
            /**
             * Adds multiple lines, each represented by two vertices in a vertex array. The given index array contains
             * pairs of indices, where each pair consists of the index of the first and the index of the second vertex.
             *
             ...
             * triples of indices, where each triple consists of the indices of the three vertices making up the
             * triangle to add.
             *
            ...
            /**
             * Adds multiple quads, each represented by four vertices in a vertex array. The given index array contains
             * four-tuples of indices, where each tuple consists of the indices of the four vertices making up the
             * quad to add.
             *
            ...
            /**
             * Adds multiple quads by adding a range of indices specified by the given base index and length. Specifically,
             * a call to this method records a sequence of indices which is computed using the given base index and
            ...
            /**
             * Adds a polygon with the given indices. Note that the polygon is translated to a set of triangles and no
             * actual polygon is recorded at all.
             *
            ...
            /**
             * Adds a polygon with indices computed from the given range. The polygons vertices are expected to be
             * stored sequentially in a vertex array, starting at the given base index. The given vertex count indicates
             * the number of vertices to add. Note that the polygon is translated to a set of triangles.
             *
