...
public:
  ...
  {
    add(material, Renderer::PrimType::Points, m_vertexListBuilder.addPoint(v));
  }
  ...
  {
    add(material, Renderer::PrimType::Points, m_vertexListBuilder.addPoints(vertices));
  }
  ...
  {
    add(material, Renderer::PrimType::Lines, m_vertexListBuilder.addLine(v1, v2));
  }
  ...
  {
    add(material, Renderer::PrimType::Lines, m_vertexListBuilder.addLines(vertices));
  }
  ...
  void addLineStrip(const Material* material, const VertexList& vertices)
  {
    add(
      material,
      Renderer::PrimType::LineStrip,
      m_vertexListBuilder.addLineStrip(vertices));
  }
  ...
  {
    add(
      material, Renderer::PrimType::LineLoop, m_vertexListBuilder.addLineLoop(vertices));
  }
  ...
  void addTriangles(const Material* material, const VertexList& vertices)
  {
    add(
      material,
      Renderer::PrimType::Triangles,
      m_vertexListBuilder.addTriangles(vertices));
  }
  ...
  void addQuad(
    ...
    const Vertex& v4)
  {
    add(material, Renderer::PrimType::Quads, m_vertexListBuilder.addQuad(v1, v2, v3, v4));
  }
  ...
  {
    add(material, Renderer::PrimType::Quads, m_vertexListBuilder.addQuads(vertices));
  }
  ...
  void addQuadStrip(const Material* material, const VertexList& vertices)
  {
    add(
      material,
      Renderer::PrimType::QuadStrip,
      m_vertexListBuilder.addQuadStrip(vertices));
  }
  ...
  {
    add(material, Renderer::PrimType::Polygon, m_vertexListBuilder.addPolygon(vertices));
  }
