...
namespace TrenchBroom {
    namespace Renderer {
        ...
        const TexturedIndexArrayMapBuilder::IndexList& TexturedIndexArrayMapBuilder::indices() const {
            return m_indices;
        }
        ...
        const TexturedIndexArrayMap& TexturedIndexArrayMapBuilder::ranges() const {
            return m_ranges;
        }
