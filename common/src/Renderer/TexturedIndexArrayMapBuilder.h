...
namespace TrenchBroom {
    ...
    namespace Renderer {
         ...
         * index array that can be uploaded to video card memory, and to render the recorded textured primitives with
         * the indices from that array using the constructed textured index array map.
         */
        ...
        public:
            ...
            /**
             * Adds multiple textured points, represented by the vertices in a vertex array at the given indices.
             *
             * @param texture the texture to use
            ...
            /**
             * Adds multiple textured lines, each represented by two vertices in a vertex array. The given index array
             * contains pairs of indices, where each pair consists of the index of the first and the index of the second
             * vertex.
             *
             * @param texture the texture to use
            ...
            /**
             * Adds multiple textured triangles, each represented by three vertices in a vertex array. The given index
             * array contains triples of indices, where each triple consists of the indices of the three vertices making
             * up the triangle to add.
             *
             * @param texture the texture to use
            ...
            /**
             * Adds multiple textured quads, each represented by four vertices in a vertex array. The given index array
             * contains four-tuples of indices, where each tuple consists of the indices of the four vertices making up
             * the quad to add.
             *
             * @param texture the texture to use
            ...
            /**
             * Adds multiple textured quads by adding a range of indices specified by the given base index and length.
             * Specifically, a call to this method records a sequence of indices which is computed using the given base
             * index and vertex count as follows.
             *
             * index 1 = baseIndex + 0;
             * index 2 = baseIndex + 1;
             * ...
            ...
            /**
             * Adds a textured polygon with the given indices. Note that the polygon is translated to a set of textured
            ...
            /**
             * Adds a textured polygon with indices computed from the given range. The polygons vertices are expected to
             * be stored sequentially in a vertex array, starting at the given base index. The given vertex count
             * indicates the number of vertices to add. Note that the polygon is translated to a set of triangles.
             *
             * @param texture the texture to use
