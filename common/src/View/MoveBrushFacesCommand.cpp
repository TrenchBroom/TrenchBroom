...
namespace TrenchBroom {
    namespace View {
        ...
        MoveBrushFacesCommand::MoveBrushFacesCommand(const std::vector<Model::Brush*>& brushes, const Model::BrushFacesMap& faces, const std::vector<vm::polygon3>& facePositions, const vm::vec3& delta) :
