...
namespace TrenchBroom {
    ...
    namespace View {
        ...
        private:
            static std::vector<vm::vec3> selectHelpVectors(Model::BrushNode* node, Model::BrushFace* face, const vm::vec3& hitPoint);
            static std::vector<Model::BrushFace*> selectIncidentFaces(Model::BrushNode* node, Model::BrushFace* face, const vm::vec3& hitPoint);
        private:
            class Callback3D;
        public:
