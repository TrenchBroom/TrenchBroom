...
namespace TrenchBroom {
    namespace View {
        ...
        void PreferenceDialog::createGui() {
            const auto gamesImage    = IO::loadIconResourceQt(IO::Path("GeneralPreferences.svg"));
            const auto viewImage     = IO::loadIconResourceQt(IO::Path("ViewPreferences.svg"));
            const auto mouseImage    = IO::loadIconResourceQt(IO::Path("MousePreferences.svg"));
            const auto keyboardImage = IO::loadIconResourceQt(IO::Path("KeyboardPreferences.svg"));
