...
namespace TrenchBroom {
    namespace View {
        typedef enum {
            ...
            ActionContext_VertexToolOld      = 1 << 2,
            ...
            ActionContext_AnyTool         = ActionContext_VertexToolOld | ActionContext_ClipTool | ActionContext_RotateTool | ActionContext_CreateComplexBrushTool,
