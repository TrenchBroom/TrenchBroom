...
DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_CUSTOM_EVENT, EVT_FLAG_CHANGED_EVENT, 1)
//DECLARE_EVENT_TYPE(EVT_FLAG_CHANGED_EVENT, 1)
END_DECLARE_EVENT_TYPES()

typedef void (wxEvtHandler::*flagChangedEventFunction)(TrenchBroom::View::FlagChangedCommand&);

#define EVT_FLAG_CHANGED_HANDLER(func) \
    (wxObjectEventFunction) \
    (flagChangedEventFunction) & func

#define EVT_FLAG_CHANGED(id,func) \
    DECLARE_EVENT_TABLE_ENTRY(EVT_FLAG_CHANGED_EVENT, \
        id, \
        wxID_ANY, \
        (wxObjectEventFunction) \
        (flagChangedEventFunction) & func, \
