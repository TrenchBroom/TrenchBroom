...
DrawBrushToolPage::DrawBrushToolPage(
  ...
  , m_document{std::move(document)}
{
  ...
  m_notifierConnection += extensionManager.currentExtensionDidChangeNotifier.connect(
    this, &DrawBrushToolPage::currentExtensionDidChange);
}

void DrawBrushToolPage::createGui(DrawBrushToolExtensionManager& extensionManager)
{
...
void DrawBrushToolPage::currentExtensionDidChange(size_t index)
{
