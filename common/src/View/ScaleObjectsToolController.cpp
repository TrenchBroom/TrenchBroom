...
namespace TrenchBroom {
    namespace View {
        class ScaleObjectsToolController::RotateObjectsBase : public ToolControllerBase<NoPickingPolicy, NoKeyPolicy, MousePolicy, RestrictedDragPolicy, RenderPolicy, NoDropPolicy> {
        protected:
        ...
        private:
            ...
            FloatType m_angle;
        protected:
            RotateObjectsBase(ScaleObjectsTool* tool) :
            m_tool(tool) {
        ...
        class ScaleObjectsToolController::MoveCenterBase : public MoveToolController<NoPickingPolicy, NoMousePolicy> {
        protected:
            ScaleObjectsTool* m_tool;
        protected:
            MoveCenterBase(ScaleObjectsTool* tool) :
        ...
        class ScaleObjectsToolController2D::MoveCenterPart : public MoveCenterBase {
        public:
            MoveCenterPart(ScaleObjectsTool* tool) :
            MoveCenterBase(tool) {}
        private:
        ...
        class ScaleObjectsToolController2D::RotateObjectsPart : public RotateObjectsBase {
        public:
            RotateObjectsPart(ScaleObjectsTool* tool) :
        ...
        Model::Hit ScaleObjectsToolController2D::doPick(const InputState& inputState) {
            return m_tool->pick2D(inputState.pickRay(), inputState.camera());
        }

        void ScaleObjectsToolController2D::doRenderHandle(Renderer::RenderContext& renderContext, Renderer::RenderBatch& renderBatch) {
            m_tool->renderHandle2D(renderContext, renderBatch);
        }
        
        
        class ScaleObjectsToolController3D::MoveCenterPart : public MoveCenterBase {
        public:
            MoveCenterPart(ScaleObjectsTool* tool) :
            MoveCenterBase(tool) {}
        private:
        ...
        class ScaleObjectsToolController3D::RotateObjectsPart : public RotateObjectsBase {
        public:
            RotateObjectsPart(ScaleObjectsTool* tool) :
            RotateObjectsBase(tool) {}
        private:
        ...
        Model::Hit ScaleObjectsToolController3D::doPick(const InputState& inputState) {
            return m_tool->pick3D(inputState.pickRay(), inputState.camera());
        }
        
        void ScaleObjectsToolController3D::doRenderHandle(Renderer::RenderContext& renderContext, Renderer::RenderBatch& renderBatch) {
