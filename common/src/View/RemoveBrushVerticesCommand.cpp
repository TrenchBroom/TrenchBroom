...
namespace TrenchBroom {
    namespace View {
        ...
        std::shared_ptr<RemoveBrushVerticesCommand> RemoveBrushVerticesCommand::remove(const VertexToBrushesMap& vertices) {
            ...
            return std::make_shared<RemoveBrushVerticesCommand>(brushes, brushVertices, vertexPositions);
        }
