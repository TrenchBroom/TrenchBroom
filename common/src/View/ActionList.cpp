...
namespace TrenchBroom {
    namespace View {
        ...
        ActionList::ActionList() {
            controlsMapViewCreatebrushInfo = addShortcut(IO::Path("Controls/Map view/Create brush"), QKeySequence(Qt::Key_Return), ActionContext::CreateComplexBrushTool, true);
            controlsMapViewToggleClipSideInfo = addShortcut(IO::Path("Controls/Map view/Toggle clip side"), QKeySequence(Qt::Key_Return | Qt::CTRL), ActionContext::ClipTool, true);
            controlsMapViewPerformclipInfo = addShortcut(IO::Path("Controls/Map view/Perform clip"), QKeySequence(Qt::Key_Return), ActionContext::ClipTool, true);
            controlsMapViewMoveVerticesUpForwardInfo = addShortcut(IO::Path("Controls/Map view/Move vertices up; Move vertices forward"), QKeySequence(Qt::Key_Up), ActionContext::AnyVertexTool, true);
            controlsMapViewMoveVerticesDownBackwardInfo = addShortcut(IO::Path("Controls/Map view/Move vertices down; Move vertices backward"), QKeySequence(Qt::Key_Down), ActionContext::AnyVertexTool, true);
            controlsMapViewMoveVerticesLeftInfo = addShortcut(IO::Path("Controls/Map view/Move vertices left"), QKeySequence(Qt::Key_Left), ActionContext::AnyVertexTool, true);
            controlsMapViewMoveVerticesRightInfo = addShortcut(IO::Path("Controls/Map view/Move vertices right"), QKeySequence(Qt::Key_Right), ActionContext::AnyVertexTool, true);
            controlsMapViewMoveVerticesBackwardUpInfo = addShortcut(IO::Path("Controls/Map view/Move vertices backward; Move vertices up"), QKeySequence(Qt::Key_PageUp), ActionContext::AnyVertexTool, true);
            controlsMapViewMoveVerticesForwardDownInfo = addShortcut(IO::Path("Controls/Map view/Move vertices forward; Move vertices down"), QKeySequence(Qt::Key_PageDown), ActionContext::AnyVertexTool, true);
            controlsMapViewMoveRotationCenterUpForwardInfo = addShortcut(IO::Path("Controls/Map view/Move rotation center up; Move rotation center forward"), QKeySequence(Qt::Key_Up), ActionContext::RotateTool, true);
            controlsMapViewMoveRotationCenterDownBackwardInfo = addShortcut(IO::Path("Controls/Map view/Move rotation center down; Move rotation center backward"), QKeySequence(Qt::Key_Down), ActionContext::RotateTool, true);
            controlsMapViewMoveRotationCenterLeftInfo = addShortcut(IO::Path("Controls/Map view/Move rotation center left"), QKeySequence(Qt::Key_Left), ActionContext::RotateTool, true);
            controlsMapViewMoveRotationCenterRightInfo = addShortcut(IO::Path("Controls/Map view/Move rotation center right"), QKeySequence(Qt::Key_Right), ActionContext::RotateTool, true);
            controlsMapViewMoveRotationCenterBackwardUpInfo = addShortcut(IO::Path("Controls/Map view/Move rotation center backward; Move rotation center up"), QKeySequence(Qt::Key_PageUp), ActionContext::RotateTool, true);
            controlsMapViewMoveRotationCenterForwardDownInfo = addShortcut(IO::Path("Controls/Map view/Move rotation center forward; Move rotation center down"), QKeySequence(Qt::Key_PageDown), ActionContext::RotateTool, true);
            controlsMapViewMoveObjectsUpForwardInfo = addShortcut(IO::Path("Controls/Map view/Move objects up; Move objects forward"), QKeySequence(Qt::Key_Up), ActionContext::NodeSelection, true);
            controlsMapViewMoveObjectsDownBackwardInfo = addShortcut(IO::Path("Controls/Map view/Move objects down; Move objects backward"), QKeySequence(Qt::Key_Down), ActionContext::NodeSelection, true);
            controlsMapViewMoveObjectsLeftInfo = addShortcut(IO::Path("Controls/Map view/Move objects left"), QKeySequence(Qt::Key_Left), ActionContext::NodeSelection, true);
            controlsMapViewMoveObjectsRightInfo = addShortcut(IO::Path("Controls/Map view/Move objects right"), QKeySequence(Qt::Key_Right), ActionContext::NodeSelection, true);
            controlsMapViewMoveObjectsBackwardUupInfo = addShortcut(IO::Path("Controls/Map view/Move objects backward; Move objects up"), QKeySequence(Qt::Key_PageUp), ActionContext::NodeSelection, true);
            controlsMapViewMoveObjectsForwardDownInfo = addShortcut(IO::Path("Controls/Map view/Move objects forward; Move objects down"), QKeySequence(Qt::Key_PageDown), ActionContext::NodeSelection, true);
            controlsMapViewRollObjectsClockwiseInfo = addShortcut(IO::Path("Controls/Map view/Roll objects clockwise"), QKeySequence(Qt::Key_Up | Qt::ALT), ActionContext::NodeSelection | ActionContext::RotateTool, true);
            controlsMapViewRollObjectsCounterClockwiseInfo = addShortcut(IO::Path("Controls/Map view/Roll objects counter-clockwise"), QKeySequence(Qt::Key_Down | Qt::ALT), ActionContext::NodeSelection | ActionContext::RotateTool, true);
            controlsMapViewYawObjectsClockwiseInfo = addShortcut(IO::Path("Controls/Map view/Yaw objects clockwise"), QKeySequence(Qt::Key_Left | Qt::ALT), ActionContext::NodeSelection | ActionContext::RotateTool, true);
            controlsMapViewYawObjectsCounterClockwiseInfo = addShortcut(IO::Path("Controls/Map view/Yaw objects counter-clockwise"), QKeySequence(Qt::Key_Right | Qt::ALT), ActionContext::NodeSelection | ActionContext::RotateTool, true);
            controlsMapViewPitchobjectsClockwiseInfo = addShortcut(IO::Path("Controls/Map view/Pitch objects clockwise"), QKeySequence(Qt::Key_PageUp | Qt::ALT), ActionContext::NodeSelection | ActionContext::RotateTool, true);
            controlsMapViewPitchobjectsCounterClockwiseInfo = addShortcut(IO::Path("Controls/Map view/Pitch objects counter-clockwise"), QKeySequence(Qt::Key_PageDown | Qt::ALT), ActionContext::NodeSelection | ActionContext::RotateTool, true);
            controlsMapViewFlipobjectsHorizontallyInfo = addShortcut(IO::Path("Controls/Map view/Flip objects horizontally"), QKeySequence('F' | Qt::CTRL), ActionContext::NodeSelection, true);
            controlsMapViewFlipobjectsBerticallyInfo = addShortcut(IO::Path("Controls/Map view/Flip objects vertically"), QKeySequence('F' | Qt::CTRL | Qt::ALT), ActionContext::NodeSelection, true);
            controlsMapViewDuplicateAndMoveObjectsUpForwardInfo = addShortcut(IO::Path("Controls/Map view/Duplicate and move objects up; Duplicate and move objects forward"), QKeySequence(Qt::Key_Up | Qt::CTRL), ActionContext::NodeSelection, true);
            controlsMapViewDuplicateAndMoveObjectsDownBackwardInfo = addShortcut(IO::Path("Controls/Map view/Duplicate and move objects down; Duplicate and move objects backward"), QKeySequence(Qt::Key_Down | Qt::CTRL), ActionContext::NodeSelection, true);
            controlsMapViewDuplicateAndMoveObjectsLeftInfo = addShortcut(IO::Path("Controls/Map view/Duplicate and move objects left"), QKeySequence(Qt::Key_Left | Qt::CTRL), ActionContext::NodeSelection, true);
            controlsMapViewDuplicateAndMoveObjectsRightInfo = addShortcut(IO::Path("Controls/Map view/Duplicate and move objects right"), QKeySequence(Qt::Key_Right | Qt::CTRL), ActionContext::NodeSelection, true);
            controlsMapViewDuplicateAndMoveObjectsBackwardUpInfo = addShortcut(IO::Path("Controls/Map view/Duplicate and move objects backward; Duplicate and move objects up"), QKeySequence(Qt::Key_PageUp | Qt::CTRL), ActionContext::NodeSelection, true);
            controlsMapViewDuplicateAndMoveObjectsForwardDownInfo = addShortcut(IO::Path("Controls/Map view/Duplicate and move objects forward; Duplicate and move objects down"), QKeySequence(Qt::Key_PageDown | Qt::CTRL), ActionContext::NodeSelection, true);
            controlsMapViewMoveTexturesupInfo = addShortcut(IO::Path("Controls/Map view/Move textures up"), QKeySequence(Qt::Key_Up), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesupFineInfo = addShortcut(IO::Path("Controls/Map view/Move textures up (fine)"), QKeySequence(Qt::Key_Up | Qt::CTRL), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesupCoarseInfo = addShortcut(IO::Path("Controls/Map view/Move textures up (coarse)"), QKeySequence(Qt::Key_Up | Qt::SHIFT), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesdownInfo = addShortcut(IO::Path("Controls/Map view/Move textures down"), QKeySequence(Qt::Key_Down), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesdownFineInfo = addShortcut(IO::Path("Controls/Map view/Move textures down (fine)"), QKeySequence(Qt::Key_Down | Qt::CTRL), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesdownCoarseInfo = addShortcut(IO::Path("Controls/Map view/Move textures down (coarse)"), QKeySequence(Qt::Key_Down | Qt::SHIFT), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesleftInfo = addShortcut(IO::Path("Controls/Map view/Move textures left"), QKeySequence(Qt::Key_Left), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesleftFineInfo = addShortcut(IO::Path("Controls/Map view/Move textures left (fine)"), QKeySequence(Qt::Key_Left | Qt::CTRL), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesleftCoarseInfo = addShortcut(IO::Path("Controls/Map view/Move textures left (coarse)"), QKeySequence(Qt::Key_Left | Qt::SHIFT), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesrightInfo = addShortcut(IO::Path("Controls/Map view/Move textures right"), QKeySequence(Qt::Key_Right), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesrightFineInfo = addShortcut(IO::Path("Controls/Map view/Move textures right (fine)"), QKeySequence(Qt::Key_Right | Qt::CTRL), ActionContext::FaceSelection, true);
            controlsMapViewMoveTexturesrightCoarseInfo = addShortcut(IO::Path("Controls/Map view/Move textures right (coarse)"), QKeySequence(Qt::Key_Right | Qt::SHIFT), ActionContext::FaceSelection, true);
            controlsMapViewRotateTexturesclockwiseInfo = addShortcut(IO::Path("Controls/Map view/Rotate textures clockwise"), QKeySequence(Qt::Key_PageUp), ActionContext::FaceSelection, true);
            controlsMapViewRotateTexturesclockwiseFineInfo = addShortcut(IO::Path("Controls/Map view/Rotate textures clockwise (fine)"), QKeySequence(Qt::Key_PageUp | Qt::CTRL), ActionContext::FaceSelection, true);
            controlsMapViewRotateTexturesclockwiseCoarseInfo = addShortcut(IO::Path("Controls/Map view/Rotate textures clockwise (coarse)"), QKeySequence(Qt::Key_PageUp | Qt::SHIFT), ActionContext::FaceSelection, true);
            controlsMapViewRotateTexturescounterClockwiseInfo = addShortcut(IO::Path("Controls/Map view/Rotate textures counter-clockwise"), QKeySequence(Qt::Key_PageDown), ActionContext::FaceSelection, true);
            controlsMapViewRotateTexturescounterClockwiseFineInfo = addShortcut(IO::Path("Controls/Map view/Rotate textures counter-clockwise (fine)"), QKeySequence(Qt::Key_PageDown | Qt::CTRL), ActionContext::FaceSelection, true);
            controlsMapViewRotateTexturescounterClockwiseCoarseInfo = addShortcut(IO::Path("Controls/Map view/Rotate textures counter-clockwise (coarse)"), QKeySequence(Qt::Key_PageDown | Qt::SHIFT), ActionContext::FaceSelection, true);
            controlsMapViewCycleMapViewInfo = addShortcut(IO::Path("Controls/Map view/Cycle map view"), QKeySequence(Qt::Key_Space), ActionContext::Any, true);
            controlsMapViewResetcamerazoomInfo = addShortcut(IO::Path("Controls/Map view/Reset camera zoom"), QKeySequence(Qt::Key_Escape | Qt::SHIFT), ActionContext::Any, true);
            controlsMapViewCancelInfo = addShortcut(IO::Path("Controls/Map view/Cancel"), QKeySequence(Qt::Key_Escape), ActionContext::Any, true);
            controlsMapViewDeactivatecurrenttoolInfo = addShortcut(IO::Path("Controls/Map view/Deactivate current tool"), QKeySequence(Qt::Key_Escape | Qt::CTRL), ActionContext::Any, true);
