...
bool GameDialog::showNewDocumentDialog(
  ...
  GameDialog dialog(
    "Select Game",
    "Select a game from the list on the right, then click OK. Once the new document is created, "
...
bool GameDialog::showOpenDocumentDialog(
  ...
  GameDialog dialog(
    "Select Game",
    "TrenchBroom was unable to detect the game for the map document. Please choose a game in the "
...
QWidget* GameDialog::createInfoPanel(
  ...
  auto* setupMsg = new QLabel(
    "To set up the game paths, click on the button below to open the preferences dialog.");
...
QWidget* GameDialog::createSelectionPanel(QWidget* parent) {
  ...
  mapFormatLayout->setContentsMargins(
    LayoutConstants::WideHMargin, LayoutConstants::NarrowVMargin, LayoutConstants::WideHMargin,
