...
namespace TrenchBroom {
    namespace View {
        ...
        EntityDefinitionFileCommand* EntityDefinitionFileCommand::set(const Assets::EntityDefinitionFileSpec& spec) {
            return new EntityDefinitionFileCommand("Set Entity Definitions", spec);
        }
