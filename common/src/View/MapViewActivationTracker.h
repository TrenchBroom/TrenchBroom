...
namespace TrenchBroom {
    namespace View {
         ...
         * mouse and keyboard events as per usual, but if it is inactive, then it requires a click on one of the map views to
         * make the group active again.
         *
         * The activation state of the group is indicated by a changed cursor; when the group is inactive, all map views have
         * a hand icon to indicate that the user must click on one of the views before it is ready for interaction.
         *
         * The map views change into the active state when the user clicks on any of the map views with the left mouse button.
         * The map views lose active state if the focus changes to any widget that is not a map view, or if the map window
         * loses its activation state.
         *
         * When the map views are in the active state, the focus will follow the mouse cursor, that is, when the user moves
         * the mouse cursor from one map view to another, then that map view will receive focus.
         */
        ...
        private:
             ...
             *
             * If the group is not in an active state, it will change into the active state and the event will be discarded.
             * Otherwise, the event will be processed as usual
             *
             * @param event the mouse event
             * @param widget the window that received the event
            ...
            /**
             * Sets the cursor of all map views to a hand cursor that indicates that the user must click to activate the group.
             */
            void setFocusCursor();
