...
namespace TrenchBroom {
    namespace View {
        ...
        bool MapDocument::flipObjects(const vm::vec3& center, const Math::Axis::Type axis) {
        ...
        bool MapDocument::resizeBrushes(const vm::polygon3::List& faces, const vm::vec3& delta) {
