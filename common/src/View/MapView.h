...
namespace TrenchBroom {
    namespace View {
        ...
        public:
            ...
            vm::vec3 pasteObjectsDelta(const bbox3& bounds, const bbox3& referenceBounds) const;
        ...
        private:
            ...
            virtual vm::vec3 doGetPasteObjectsDelta(const bbox3& bounds, const bbox3& referenceBounds) const = 0;
