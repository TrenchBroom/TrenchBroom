...
/**
 * Template specialization of the VertexType template for the case of multiple vertex
...
struct VertexType<AttrType, AttrTypeRest...>
{
  ...
  // Non-instantiable
  VertexType() = delete;
  deleteCopyAndMove(VertexType);
};

/**
 * Template specialization of the VertexType template for the case of a single vertex
 * attributes. This is the base case for the recursive calls in the multi-attribute
 * VertexType specialization above.
 *
 * @tparam AttrType the type of the vertex attribute
 */
template <typename AttrType>
struct VertexType<AttrType>
{
...
{
using P2 = VertexType<VertexAttributeTypes::P2>;
...
using P3NC4 =
  VertexType<VertexAttributeTypes::P3, VertexAttributeTypes::N, VertexAttributeTypes::C4>;
