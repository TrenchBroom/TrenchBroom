...
#ifndef TrenchBroom_NonIntegerPlanePointsIssueGenerator
#define TrenchBroom_NonIntegerPlanePointsIssueGenerator
...
#endif /* defined(TrenchBroom_NonIntegerPlanePointsIssueGenerator) */
