...
#ifndef __TrenchBroom__NonIntegerPlanePointsIssueGenerator__
#define __TrenchBroom__NonIntegerPlanePointsIssueGenerator__
...
#endif /* defined(__TrenchBroom__NonIntegerPlanePointsIssueGenerator__) */
