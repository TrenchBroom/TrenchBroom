...
#ifndef __TrenchBroom__FindMatchingBrushFaceVisitor__
#define __TrenchBroom__FindMatchingBrushFaceVisitor__
...
#endif /* defined(__TrenchBroom__FindMatchingBrushFaceVisitor__) */
