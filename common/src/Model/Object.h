...
namespace TrenchBroom {
    namespace Model {
        ...
        public:
            ...
            void transform(const mat4x4& transformation, bool lockTextures, const vm::bbox3& worldBounds);
        ...
        private: // subclassing interface
            ...
            virtual void doTransform(const mat4x4& transformation, bool lockTextures, const vm::bbox3& worldBounds) = 0;
