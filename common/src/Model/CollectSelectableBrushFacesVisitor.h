...
#ifndef __TrenchBroom__CollectSelectableBrushFacesVisitor__
#define __TrenchBroom__CollectSelectableBrushFacesVisitor__
...
#endif /* defined(__TrenchBroom__CollectSelectableBrushFacesVisitor__) */
