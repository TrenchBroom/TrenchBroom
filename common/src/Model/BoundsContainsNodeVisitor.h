...
#ifndef __TrenchBroom__BoundsContainsNodeVisitor__
#define __TrenchBroom__BoundsContainsNodeVisitor__
...
#endif /* defined(__TrenchBroom__BoundsContainsNodeVisitor__) */
