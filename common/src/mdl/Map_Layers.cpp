...
void Map::moveSelectionToLayer(LayerNode* layer)
{
...
bool Map::canMoveSelectionToLayer(LayerNode* layer) const
{
  ensure(layer != nullptr, "null layer");
...
void Map::setOmitLayerFromExport(mdl::LayerNode* layerNode, const bool omitFromExport)
{
  ...
  updateNodeContents(commandName, {{layerNode, mdl::NodeContents(std::move(layer))}}, {});
}
