...
bool Map::renameProperty(const std::string& oldKey, const std::string& newKey)
{
  const auto entityNodes = selection().allEntities();
  return applyAndSwap(
    *this,
...
bool Map::removeProperty(const std::string& key)
{
  const auto entityNodes = selection().allEntities();
  return applyAndSwap(
    *this,
...
bool Map::setProtectedProperty(const std::string& key, const bool value)
{
  const auto entityNodes = selection().allEntities();
...
bool Map::clearProtectedProperties()
{
  const auto entityNodes = selection().allEntities();
...
bool Map::canClearProtectedProperties() const
{
  const auto entityNodes = selection().allEntities();
  if (
    entityNodes.empty()
...
void Map::setDefaultProperties(const SetDefaultPropertyMode mode)
{
  const auto entityNodes = selection().allEntities();
  applyAndSwap(
    *this,
