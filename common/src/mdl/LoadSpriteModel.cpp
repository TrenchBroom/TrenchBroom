...
Result<Orientation> parseSpriteOrientationType(fs::Reader& reader)
{
  ...
  return static_cast<Orientation>(type);
}
...
Result<Palette> parseEmbeddedPalette(
  fs::Reader& reader,
...
Result<EntityModelData> loadSpriteModel(
