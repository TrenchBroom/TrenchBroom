...
namespace TrenchBroom {
    ...
    namespace Assets {
        ...
        public:
            PointEntityDefinition(const std::string& name, const Color& color, const vm::bbox3& bounds, const std::string& description, const PropertyDefinitionList& propertyDefinitions, const ModelDefinition& modelDefinition, const SpriteDefinition& spriteDefinition);
