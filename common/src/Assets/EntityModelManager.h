...
namespace TrenchBroom {
    ...
    namespace Assets {
        ...
        private:
            ...
            typedef std::map<Assets::ModelSpecification, Renderer::TexturedIndexArrayRenderer*> RendererCache;
            typedef std::set<Assets::ModelSpecification> RendererMismatches;
            typedef std::vector<Renderer::TexturedIndexArrayRenderer*> RendererList;
        ...
        public:
            ...
            Renderer::TexturedIndexArrayRenderer* renderer(const Assets::ModelSpecification& spec) const;
        private:
