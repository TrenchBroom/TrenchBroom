...
namespace TrenchBroom {
    namespace Assets {
        ...
        Texture::Texture(const String& name, const size_t width, const size_t height, const Color& averageColor, const TextureBuffer& buffer, GLenum format) :
        m_collection(NULL),
        m_name(name),
        m_width(width),
        m_height(height),
        ...
        Texture::Texture(const String& name, const size_t width, const size_t height, const Color& averageColor, const TextureBuffer::List& buffers, GLenum format) :
        m_collection(NULL),
        m_name(name),
        m_width(width),
        m_height(height),
        ...
        Texture::Texture(const String& name, const size_t width, const size_t height, GLenum format) :
        m_collection(NULL),
        m_name(name),
        m_width(width),
        m_height(height),
