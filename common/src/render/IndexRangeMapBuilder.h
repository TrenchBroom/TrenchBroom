...
public:
  ...
  {
    add(render::PrimType::Points, m_vertexListBuilder.addPoint(v));
  }
  ...
  {
    add(render::PrimType::Points, m_vertexListBuilder.addPoints(vertices));
  }
  ...
  {
    add(render::PrimType::Lines, m_vertexListBuilder.addLine(v1, v2));
  }
  ...
  {
    add(render::PrimType::Lines, m_vertexListBuilder.addLines(vertices));
  }
  ...
  {
    add(render::PrimType::LineStrip, m_vertexListBuilder.addLineStrip(vertices));
  }
  ...
  {
    add(render::PrimType::LineLoop, m_vertexListBuilder.addLineLoop(vertices));
  }
  ...
  {
    add(render::PrimType::Triangles, m_vertexListBuilder.addTriangle(v1, v2, v3));
  }
  ...
  {
    add(render::PrimType::Triangles, m_vertexListBuilder.addTriangles(vertices));
  }
  ...
  {
    add(render::PrimType::TriangleFan, m_vertexListBuilder.addTriangleFan(vertices));
  }
  ...
  {
    add(render::PrimType::TriangleStrip, m_vertexListBuilder.addTriangleStrip(vertices));
  }
  ...
  {
    add(render::PrimType::Quads, m_vertexListBuilder.addQuad(v1, v2, v3, v4));
  }
  ...
  {
    add(render::PrimType::Quads, m_vertexListBuilder.addQuads(vertices));
  }
  ...
  {
    add(render::PrimType::QuadStrip, m_vertexListBuilder.addQuadStrip(vertices));
  }
  ...
  {
    add(render::PrimType::Polygon, m_vertexListBuilder.addPolygon(vertices));
  }
