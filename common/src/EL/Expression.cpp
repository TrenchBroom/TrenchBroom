...
namespace TrenchBroom {
    namespace EL {
        ...
        void Expression::rebalanceByPrecedence() {
             ...
             * than or equal to the precedences of its children. This guarantees that evaluating the tree in a depth 
             * first traversal yields correct results because the nodes with the highest precedence are evaluated before
             * the nodes with lower precedence.
             */
