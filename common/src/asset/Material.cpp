...
void Material::activate(const int minFilter, const int magFilter) const
{
      ...
      texture && texture->activate(minFilter, magFilter))
  {
    switch (m_culling)
    {
    case asset::MaterialCulling::None:
      glAssert(glDisable(GL_CULL_FACE));
      break;
    case asset::MaterialCulling::Front:
      glAssert(glCullFace(GL_FRONT));
      break;
    case asset::MaterialCulling::Both:
      glAssert(glCullFace(GL_FRONT_AND_BACK));
      break;
    case asset::MaterialCulling::Default:
    case asset::MaterialCulling::Back:
      break;
    }
