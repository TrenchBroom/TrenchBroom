...
public:
    ...
    public:
        ...
        V normal() const;
        V center() const;
        T intersectWithRay(const vm::ray<T,3>& ray, const Math::Side side) const;
...
private:
    ...
    static Math::PointStatus::Type pointStatus(const vm::plane<T,3>& plane, const Vertex* vertices);
};
