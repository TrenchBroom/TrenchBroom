...
/**
 * The search/filter query language's Binding for a BrushNode -- the fields common to
...
/**
 * The field names makeBrushNodeBinding's result exposes, without needing an actual
 * node instance.
 */
