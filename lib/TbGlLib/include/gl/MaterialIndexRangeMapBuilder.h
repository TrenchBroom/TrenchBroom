...
public:
  ...
  {
    add(material, PrimType::Points, m_vertexListBuilder.addPoint(v));
  }
  ...
  {
    add(material, PrimType::Points, m_vertexListBuilder.addPoints(vertices));
  }
  ...
  {
    add(material, PrimType::Lines, m_vertexListBuilder.addLine(v1, v2));
  }
  ...
  {
    add(material, PrimType::Lines, m_vertexListBuilder.addLines(vertices));
  }
  ...
  {
    add(material, PrimType::LineStrip, m_vertexListBuilder.addLineStrip(vertices));
  }
  ...
  {
    add(material, PrimType::LineLoop, m_vertexListBuilder.addLineLoop(vertices));
  }
  ...
  {
    add(material, PrimType::Triangles, m_vertexListBuilder.addTriangle(v1, v2, v3));
  }
  ...
  {
    add(material, PrimType::Triangles, m_vertexListBuilder.addTriangles(vertices));
  }
  ...
  {
    add(material, PrimType::TriangleFan, m_vertexListBuilder.addTriangleFan(vertices));
  }
  ...
  {
    add(
      material, PrimType::TriangleStrip, m_vertexListBuilder.addTriangleStrip(vertices));
  }
  ...
  void addQuad(
    ...
    const Vertex& v4)
  {
    add(material, PrimType::Quads, m_vertexListBuilder.addQuad(v1, v2, v3, v4));
  }
  ...
  {
    add(material, PrimType::Quads, m_vertexListBuilder.addQuads(vertices));
  }
  ...
  {
    add(material, PrimType::QuadStrip, m_vertexListBuilder.addQuadStrip(vertices));
  }
  ...
  {
    add(material, PrimType::Polygon, m_vertexListBuilder.addPolygon(vertices));
  }
