...
void EntityRenderer::renderModels(RenderContext&, RenderBatch& renderBatch)
{
...
void EntityRenderer::renderTransparentModels(RenderContext&, RenderBatch& renderBatch)
{
  m_modelRenderer.setApplyTinting(m_tint);
  m_modelRenderer.setTintColor(m_tintColor);
  m_modelRenderer.setShowHiddenEntities(m_showHiddenEntities);
