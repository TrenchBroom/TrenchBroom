...
void TwoPaneMapView::createGui(AppController& appController, MapViewToolBox& toolBox)
{
  ...
  m_mapView2D =
    new CyclingMapView{appController, m_document, toolBox, CyclingMapView::View_2D};
