 ...
 * path, and which ql::QueryObjectTypes it's meaningful on.
 *
 ...
 * are bound directly on WorldNodeLazyMap/EntityNodeLazyMap (a world/entity node's own
 * data), while BrushNodeLazyMap/PatchNodeLazyMap/BrushFaceLazyMap only expose their
