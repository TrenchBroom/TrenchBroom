...
namespace Gwen
{
	namespace Skin
	{
        ...
        public:
            ...
            virtual void DrawLeftStripButton( Controls::Base* control, bool bDepressed, bool bHovered, bool bDisabled )
            {
                if ( bDisabled )	return Textures.Input.StripButton.Left.Disabled.Draw( GetRender(), control->GetRenderBounds() );
                if ( bDepressed )	return Textures.Input.StripButton.Left.Pressed.Draw( GetRender(), control->GetRenderBounds() );
                if ( bHovered )		return Textures.Input.StripButton.Left.Hovered.Draw( GetRender(), control->GetRenderBounds() );

                Textures.Input.StripButton.Left.Normal.Draw( GetRender(), control->GetRenderBounds() );
            }

            virtual void DrawMidStripButton( Controls::Base* control, bool bDepressed, bool bHovered, bool bDisabled )
            {
                if ( bDisabled )	return Textures.Input.StripButton.Mid.Disabled.Draw( GetRender(), control->GetRenderBounds() );
                if ( bDepressed )	return Textures.Input.StripButton.Mid.Pressed.Draw( GetRender(), control->GetRenderBounds() );
                if ( bHovered )		return Textures.Input.StripButton.Mid.Hovered.Draw( GetRender(), control->GetRenderBounds() );

                Textures.Input.StripButton.Mid.Normal.Draw( GetRender(), control->GetRenderBounds() );
            }

            virtual void DrawRightStripButton( Controls::Base* control, bool bDepressed, bool bHovered, bool bDisabled )
            {
                if ( bDisabled )	return Textures.Input.StripButton.Right.Disabled.Draw( GetRender(), control->GetRenderBounds() );
                if ( bDepressed )	return Textures.Input.StripButton.Right.Pressed.Draw( GetRender(), control->GetRenderBounds() );
                if ( bHovered )		return Textures.Input.StripButton.Right.Hovered.Draw( GetRender(), control->GetRenderBounds() );

                Textures.Input.StripButton.Right.Normal.Draw( GetRender(), control->GetRenderBounds() );
            }
