...
namespace Gwen
{
    namespace Controls
    {
        ...
        GWEN_CONTROL_CONSTRUCTOR( ResizableControl )
        {
            ...
            m_Resizer[2] = new ControlsInternal::Resizer (this );
            ...
            m_Resizer[1] = new ControlsInternal::Resizer( m_Resizer[2] );
            ...
            m_Resizer[3] = new ControlsInternal::Resizer( m_Resizer[2] );
            ...
            m_Resizer[8] = new ControlsInternal::Resizer( this );
            ...
            m_Resizer[7] = new ControlsInternal::Resizer( m_Resizer[8] );
            ...
            m_Resizer[9] = new ControlsInternal::Resizer( m_Resizer[8] );
            ...
            m_Resizer[4] = new ControlsInternal::Resizer( this );
            ...
            m_Resizer[6] = new ControlsInternal::Resizer( this );
        ...
        void ResizableControl::DisableResizing()
        {
            ...
            {
                ControlsInternal::Resizer* resizer = gwen_cast<ControlsInternal::Resizer>(*it);
                if ( !resizer ) continue;
