...
namespace Gwen
{
    namespace Controls
    {
        ...
        void ColorPicker::CreateColorControl( Gwen::String name, int y )
        {
            ...
            ControlsInternal::ColorDisplay* disp = new ControlsInternal::ColorDisplay( colorGroup );
            disp->SetName(name);
        ...
        void ColorPicker::CreateControls()
        {
            ...
            ControlsInternal::ColorDisplay* disp = new ControlsInternal::ColorDisplay( finalGroup );
            disp->SetName( "Result" );
        ...
        {
            ControlsInternal::ColorDisplay* disp = gwen_cast<ControlsInternal::ColorDisplay>(FindChildByName( name, true ) );
            disp->SetColor( col );
        ...
        void ColorPicker::UpdateControls()
        {
            ...
            ControlsInternal::ColorDisplay* disp = gwen_cast<ControlsInternal::ColorDisplay>( FindChildByName( "Result", true ) );
