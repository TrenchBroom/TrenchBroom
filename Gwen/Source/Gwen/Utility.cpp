...
namespace Gwen
{
    namespace Utility
    {
        ...
        void Strings::Split( const Gwen::String& str, const Gwen::String& seperator, Strings::List& outbits, bool bLeave )
        {
            size_t iOffset = 0;
        ...
        void Strings::Split( const Gwen::UnicodeString& str, const Gwen::UnicodeString& seperator, Strings::UnicodeList& outbits, bool bLeave )
        {
            size_t iOffset = 0;
            size_t iLength = str.length();
            size_t iSepLen = seperator.length();
        ...
        bool Strings::Wildcard( const TextObject& strWildcard, const TextObject& strHaystack )
        {
        ...
        void Strings::ToUpper( Gwen::UnicodeString& str )
        {
            transform( str.begin(), str.end(), str.begin(), towupper );
        }
        
        void Strings::Strip( Gwen::UnicodeString& str, const Gwen::UnicodeString& chars )
        {
