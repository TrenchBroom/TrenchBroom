...
namespace TrenchBroom {
    ...
    namespace View {
        class CameraTool : public Tool<NoActivationPolicy, NoPickingPolicy, MousePolicy, MouseDragPolicy, NoDropPolicy, NoRenderPolicy> {
        private:
            Renderer::Camera& m_camera;
            bool m_orbit;
            Vec3f m_orbitCenter;
        public:
            CameraTool(BaseTool* next, MapDocumentWPtr document, ControllerWPtr controller, Renderer::Camera& camera);
        private:
