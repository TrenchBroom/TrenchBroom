...
#ifndef __TrenchBroom__QuakeModelFactory__
#define __TrenchBroom__QuakeModelFactory__
...
namespace TrenchBroom {
    namespace Model {
        class QuakeModelFactory : public ModelFactory {
        private:
            MapFormat m_format;
        public:
            QuakeModelFactory(const MapFormat format);
        private:
            Entity* doCreateEntity() const;
            Brush* doCreateBrush(const BBox3& worldBounds, const BrushFaceList& faces) const;
            BrushFace* doCreateFace(const Vec3& point0, const Vec3& point1, const Vec3& point2, const String& textureName) const;
...
#endif /* defined(__TrenchBroom__QuakeModelFactory__) */
