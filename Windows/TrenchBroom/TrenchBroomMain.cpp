...
const long TrenchBroomFrame::ID_GLCANVAS1 = wxNewId();
...
TrenchBroomFrame::TrenchBroomFrame(wxWindow* parent,wxWindowID id)
{
    ...
    int GLCanvasAttributes_1[] = {
    	...
    	0, 0 };
    GLCanvas1 = new wxGLCanvas(this, ID_GLCANVAS1, wxPoint(232,432), wxDefaultSize, 0, _T("ID_GLCANVAS1"), GLCanvasAttributes_1);
