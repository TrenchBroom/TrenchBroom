...
namespace TrenchBroom {
    namespace Model {
        ...
        void MacPreferences::loadPlatformDefaults() {
            ...
            m_cameraOrbitKey = Controller::Tool::TB_MK_SHIFT | Controller::Tool::TB_MK_CMD;
            m_selectionToolMultiKey = Controller::Tool::TB_MK_CMD;
            m_selectionToolGridKey = Controller::Tool::TB_MK_ALT;
            m_resizeToolKey = Controller::Tool::TB_MK_CMD;
