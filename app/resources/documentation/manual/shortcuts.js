...
menu["Menu/File/Export/Wavefront OBJ"] = { path: ["File", "Export", "Wavefront OBJ..."], shortcut: { key:79, modifiers: [] } };
...
menu["Menu/Edit/CSG/Hollow"] = { path: ["Edit", "CSG", "Hollow"], shortcut: { key:72, modifiers: [] } };
...
actions["Controls/Map view/Toggle fly mode"] = { key:73, modifiers: [] };
