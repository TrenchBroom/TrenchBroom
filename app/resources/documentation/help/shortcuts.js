...
menu["Menu/Edit/Repeat"] = { path: ["Edit", "Repeat"], shortcut: { key:74, modifiers: [308] } };
...
menu["Menu/Edit/Paste at Original Position"] = { path: ["Edit", "Paste at Original Position"], shortcut: { key:86, modifiers: [306, 308] } };
...
menu["Menu/Edit/Select Siblings"] = { path: ["Edit", "Select Siblings"], shortcut: { key:65, modifiers: [307, 308] } };
menu["Menu/Edit/Select Touching"] = { path: ["Edit", "Select Touching"], shortcut: { key:84, modifiers: [307, 308] } };
menu["Menu/Edit/Select Inside"] = { path: ["Edit", "Select Inside"], shortcut: { key:73, modifiers: [307, 308] } };
...
menu["Menu/Edit/Hide"] = { path: ["Edit", "Hide"], shortcut: { key:72, modifiers: [308] } };
menu["Menu/Edit/Isolate"] = { path: ["Edit", "Isolate"], shortcut: { key:73, modifiers: [308] } };
menu["Menu/Edit/Show All"] = { path: ["Edit", "Show All"], shortcut: { key:72, modifiers: [306, 308] } };
...
menu["Menu/Edit/CSG/Convex Merge"] = { path: ["Edit", "CSG", "Convex Merge"], shortcut: { key:43, modifiers: [306, 308] } };
menu["Menu/Edit/CSG/Subtract"] = { path: ["Edit", "CSG", "Subtract"], shortcut: { key:45, modifiers: [306, 308] } };
menu["Menu/Edit/CSG/Intersect"] = { path: ["Edit", "CSG", "Intersect"], shortcut: { key:58, modifiers: [306, 308] } };
menu["Menu/Edit/CSG/Partition"] = { path: ["Edit", "CSG", "Partition"], shortcut: { key:35, modifiers: [306, 308] } };
menu["Menu/Edit/Snap Vertices"] = { path: ["Edit", "Snap Vertices"], shortcut: { key:86, modifiers: [307, 306] } };
...
menu["Menu/View/Grid/Show Grid"] = { path: ["View", "Grid", "Show Grid"], shortcut: { key:48, modifiers: [308] } };
menu["Menu/View/Grid/Snap to Grid"] = { path: ["View", "Grid", "Snap to Grid"], shortcut: { key:48, modifiers: [306, 308] } };
menu["Menu/View/Grid/Increase Grid Size"] = { path: ["View", "Grid", "Increase Grid Size"], shortcut: { key:43, modifiers: [308] } };
menu["Menu/View/Grid/Decrease Grid Size"] = { path: ["View", "Grid", "Decrease Grid Size"], shortcut: { key:45, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 1"] = { path: ["View", "Grid", "Set Grid Size 1"], shortcut: { key:49, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 2"] = { path: ["View", "Grid", "Set Grid Size 2"], shortcut: { key:50, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 4"] = { path: ["View", "Grid", "Set Grid Size 4"], shortcut: { key:51, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 8"] = { path: ["View", "Grid", "Set Grid Size 8"], shortcut: { key:52, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 16"] = { path: ["View", "Grid", "Set Grid Size 16"], shortcut: { key:53, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 32"] = { path: ["View", "Grid", "Set Grid Size 32"], shortcut: { key:54, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 64"] = { path: ["View", "Grid", "Set Grid Size 64"], shortcut: { key:55, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 128"] = { path: ["View", "Grid", "Set Grid Size 128"], shortcut: { key:56, modifiers: [308] } };
menu["Menu/View/Grid/Set Grid Size 256"] = { path: ["View", "Grid", "Set Grid Size 256"], shortcut: { key:57, modifiers: [308] } };
menu["Menu/View/Camera/Move to Next Point"] = { path: ["View", "Camera", "Move to Next Point"], shortcut: { key:43, modifiers: [306, 308] } };
menu["Menu/View/Camera/Move to Previous Point"] = { path: ["View", "Camera", "Move to Previous Point"], shortcut: { key:45, modifiers: [306, 308] } };
menu["Menu/View/Camera/Center on Selection"] = { path: ["View", "Camera", "Center on Selection"], shortcut: { key:67, modifiers: [306, 308] } };
menu["Menu/View/Camera/Move Camera to..."] = { path: ["View", "Camera", "Move Camera to..."], shortcut: { key:0, modifiers: [] } };
menu["Menu/View/Switch to Map Inspector"] = { path: ["View", "Switch to Map Inspector"], shortcut: { key:49, modifiers: [307, 306] } };
menu["Menu/View/Switch to Entity Inspector"] = { path: ["View", "Switch to Entity Inspector"], shortcut: { key:50, modifiers: [307, 306] } };
menu["Menu/View/Switch to Face Inspector"] = { path: ["View", "Switch to Face Inspector"], shortcut: { key:51, modifiers: [307, 306] } };
menu["Menu/View/Maximize Current View"] = { path: ["View", "Maximize Current View"], shortcut: { key:32, modifiers: [306] } };
menu["Menu/View/Toggle Info Panel"] = { path: ["View", "Toggle Info Panel"], shortcut: { key:79, modifiers: [307, 306] } };
menu["Menu/View/Toggle Inspector"] = { path: ["View", "Toggle Inspector"], shortcut: { key:73, modifiers: [307, 306] } };
