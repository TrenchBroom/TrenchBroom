...
namespace TrenchBroom {
    namespace Controller {
        TEST(AddRemoveObjectsCommandTest, addEntity) {
            ...
            query.addEntity(entity, layer);
            
            AddRemoveObjectsCommand::Ptr command = AddRemoveObjectsCommand::addObjects(doc, query);
            ...
            objectsWereRemoved.expect(query.objects());
        ...
        TEST(AddRemoveObjectsCommandTest, addBrushesToWorldspawn) {
            ...
            Model::AddObjectsQuery query;
            query.addBrush(brush1, doc->worldspawn(), layer);
            query.addBrush(brush2, doc->worldspawn(), layer);
            ...
            objectsWereAdded.expect(query.objects());
            ...
            objectsWillChange.expect(Model::ObjectList(1, doc->worldspawn()));
            objectsWillBeRemoved.expect(query.objects());
            objectsWereRemoved.expect(query.objects());
            objectsDidChange.expect(Model::ObjectList(1, doc->worldspawn()));
            ASSERT_TRUE(command->performUndo());
        ...
        TEST(AddRemoveObjectsCommandTest, addBrushToEntity) {
            ...
            Model::AddObjectsQuery query;
            query.addBrush(brush, entity, layer);
            ...
            // the empty entity will be automatically deleted!
            objectsWillBeRemoved.expect(Model::ObjectList(1, entity));
