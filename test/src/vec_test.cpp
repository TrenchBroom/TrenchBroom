...
TEST(VecTest, angleBetween) {
    ...
    ASSERT_FLOAT_EQ(angleBetween(vec3f::pos_y, vec3f::pos_x, vec3f::pos_z), Math::Cf::piOverTwo());
    ASSERT_FLOAT_EQ(angleBetween(vec3f::neg_x, vec3f::pos_x, vec3f::pos_z), Math::Cf::pi());
    ASSERT_FLOAT_EQ(angleBetween(vec3f::neg_y, vec3f::pos_x, vec3f::pos_z), 3.0f * Math::Cf::piOverTwo());
}
