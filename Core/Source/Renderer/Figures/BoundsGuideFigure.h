...
namespace TrenchBroom {
    namespace Renderer {
        ...
        class BoundsGuideFigure : public Figure {
        private:
            BBox m_bounds;
            Vec4f m_color;
            Vec4f m_hiddenColor;
            ...
            unsigned int writeLine(RenderContext& context, VboBlock& block, unsigned int offset, const Vec4f& color, const Vec3f& anchor, float size, const Vec3f& axis);
        public:
            BoundsGuideFigure();
            ~BoundsGuideFigure();
