...
#include "Model/Assets/TextureTypes.h"
    ...
    namespace Model {
        namespace Assets {
            ...
            public:
                ...
                TextureList textures(ETextureSortCriterion criterion) const;
            ...
            public:
                ...
                const TextureCollectionList& collections();
                const TextureList textures(ETextureSortCriterion criterion);
