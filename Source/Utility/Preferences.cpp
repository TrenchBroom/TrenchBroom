...
namespace TrenchBroom {
    namespace Preferences {
        ...
        const Preference<KeyboardShortcut>  ViewCameraMoveToNextPoint = Preference<KeyboardShortcut>(           "Menu/View/Camera/Move to Next Point",                  KeyboardShortcut(Menu::ViewMoveCameraToNextPoint, WXK_CONTROL, '+', KeyboardShortcut::SCAny, "Move to Next Point"));
        const Preference<KeyboardShortcut>  ViewCameraMoveToPreviousPoint = Preference<KeyboardShortcut>(       "Menu/View/Camera/Move to Previous Point",              KeyboardShortcut(Menu::ViewMoveCameraToPreviousPoint, WXK_CONTROL, '-', KeyboardShortcut::SCAny, "Move to Previous Point"));
