...
namespace TrenchBroom {
    namespace Preferences {
        ...
        const Preference<KeyboardShortcut>  FileSaveAs = Preference<KeyboardShortcut>(                          "Menu/File/Save as",                                    KeyboardShortcut(wxID_SAVEAS, WXK_CONTROL, WXK_SHIFT, 'S', KeyboardShortcut::SCAny, "Save as..."));
        ...
        const Preference<KeyboardShortcut>  EditSelectNone = Preference<KeyboardShortcut>(                      "Menu/Edit/Select None",                                KeyboardShortcut(Menu::EditSelectTouching, WXK_CONTROL, WXK_SHIFT, 'A', KeyboardShortcut::SCAny, "Select None"));
        ...
        const Preference<KeyboardShortcut>  ViewCameraMoveDown = Preference<KeyboardShortcut>(                  "Menu/View/Camera/Move Down",                           KeyboardShortcut(Menu::ViewMoveCameraUp, WXK_ALT, WXK_PAGEDOWN, KeyboardShortcut::SCAny, "Move Down"));
