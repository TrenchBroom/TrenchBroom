    ...
    namespace Renderer {
        ...
        void CompassRenderer::render(Vbo& vbo, RenderContext& context) {
            ...
            { // render X axis
                ...
                if (restriction.restricted(Axis::AX) || restriction.restricted(Axis::AZ)) {
                    compassShader.currentShader().setUniformVariable("MaterialDiffuse", prefs.getColor(Preferences::DisabledColor));
                    compassShader.currentShader().setUniformVariable("MaterialAmbient", prefs.getColor(Preferences::DisabledColor));
                    compassShader.currentShader().setUniformVariable("MaterialSpecular", prefs.getColor(Preferences::DisabledColor));
                } else {
            ...
            { // render Y axis
                ...
                if (restriction.restricted(Axis::AY) || restriction.restricted(Axis::AZ)) {
                    compassShader.currentShader().setUniformVariable("MaterialDiffuse", prefs.getColor(Preferences::DisabledColor));
                    compassShader.currentShader().setUniformVariable("MaterialAmbient", prefs.getColor(Preferences::DisabledColor));
                    compassShader.currentShader().setUniformVariable("MaterialSpecular", prefs.getColor(Preferences::DisabledColor));
                } else {
