...
- (void)render {
    ...
    if (texId == 0) {
        NSAttributedString* attrString = [[NSAttributedString alloc] initWithString:string attributes:[NSMutableDictionary dictionaryWithObject:[NSColor selectedTextColor] forKey:NSForegroundColorAttributeName]];
